...
Kamalika_4channel_model = load_model('./tmp/VGG16FCN_Kamlika400_RGB_NIR.h5', custom_objects={'BilinearUpSampling2D':NeMO_layers.BilinearUpSampling2D, 'charbonnierLoss': charbonnierLoss})

image_size = 80
batch_size = 12
mag = 5
model_name = 'SR_Kamalika_FeatureWise'
...
with open("init_args - SRx5_PerosBanhos.yml", 'r') as stream:
    try:
...
checkpointer = ModelCheckpoint(filepath="./tmp/" + model_name + ".h5", verbose=1, save_best_only=False)
...
conv_params = {"filters":[64,64,[64,32,4]],
    "conv_size": [(9,9),(3,3),[(3,3),(3,3),(9,9)]],
    "conv_strides": [(1,1), (1,1), (1,1)],
    "padding": ['same','same', 'same'],
    "dilation_rate": [(1,1), (1,1), (1,1)],
    "pad_size": [None,None,(1,1)],
    "filters_up": [None,None,64],
    "upconv_size": [None,None,(9,9)],
    "upconv_strides": [None, None, (5,5)],
    "upconv_type": ["","","2dtranspose"],
...
keras.utils.layer_utils.print_summary(SR_simple, line_length=150, positions=[.35, .55, .65, 1.])

optimizer = keras.optimizers.Adam(1e-4)

Featurewise_SR = SRModel_FeatureWise(hr_input_shape=(x*mag,y*mag,num_channels), lr_input_shape=(x,y,num_channels), SRModel=SR_simple, FeatureModel=Kamalika_4channel_model, FeatureLayerName="vgg_convblock2_Activ3")
