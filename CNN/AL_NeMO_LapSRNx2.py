...
batch_size = 12
mag = 2
model_name = 'SRx2_Fiji_4channel_2dTranpose_ConvUpsample'
...
conv_params = {"filters":[64,64],
    "conv_size": [[([(1,1),(3,3)], [(1,1),(6,6)], [(3,3),(1,1)]), (3,3)], (3,3)],
    "conv_strides": [(1,1), (1,1)],
    "padding": ['same','same'],
    "dilation_rate": [(1,1), (1,1)],
    "filters_up": [None, 64],
    "upconv_size": [None, (3,3)],
    "upconv_strides": [None, (2,2)],
    "upconv_type": ["","nn"],
    "layercombo": [[("cbacba","cbacba","cbacba"),"c"], [([("cbacbacbacba",""), "cbacbacbacba"], ""), "ucba"]],
    "layercombine": ["cat",["sum","sum"]],
    "full_filters": [1024,1024],
    "dropout": [0,0]}

bridge_params = {"filters": [None,num_channels],
    "conv_size": [None,(3,3)],
    "conv_strides": [None,(1,1)],
    "padding": ['same','same'],
    "dilation_rate": [None, (1,1)],
    "layercombo": ["", "ca"]}

prev_params = {"filters":[None,num_channels],
    "conv_size": [None, (3,3)],
    "conv_strides": [None, (1,1)],
    "padding": [None, 'same'],
    "dilation_rate": [None, (1,1)],
    "filters_up": [None,num_channels],
    "upconv_size": [None, (3,3)],
    "upconv_strides": [None, (2,2)],
...
decoder_index = [0,1]     # Input is added manually in the model, last one is not used
scales= [1,1]
