...
conv_params = {"filters":[([[32,8],([64,8],[])],[])],
    "conv_size": [([[(5,5),(3,3)],([(5,5),(3,3)],[])],[])],
    "conv_strides": [(1,1)],
    "padding": ['same'],
    "dilation_rate": [(1,1)],
    "pool_size": [(2,2)],
...
TestArchitecture = TestModel(input_shape=(y, x, num_channels), classes=num_classes, weight_decay=3e-3, trainable_encoder=True, weights=None,
    conv_layers=conv_layers, full_layers=0, conv_params=conv_params)

optimizer = keras.optimizers.Adam(1e-4)

TestArchitecture.summary()
TestArchitecture.compile(optimizer=optimizer, loss='categorical_crossentropy', metrics=['accuracy'], sample_weight_mode='temporal')
